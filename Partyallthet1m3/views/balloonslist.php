    ...
    class BalloonsList {
        ...
        public function __construct($admin) {
            ...
            if (!($membershipProvider->isLoggedIn())) {
                ...
                header('location: http://localhost/EcommerceProject-main/Partyallthet1m3/index.php?resource=admin&action=login');
        ...
        function render(...$data) {
            ...
            if (isset($_POST['update'])) {
                header('location: http://localhost/EcommerceProject/Partyallthet1m3/index.php?resource=balloon&action=edit&resourceid='. $_POST['updateid'] .'');
            } else if (isset($_POST['delete'])) {
                header('location: http://localhost/EcommerceProject/Partyallthet1m3/index.php?resource=balloon&action=delete&resourceid='. $_POST['deleteid'] .'');
            }
